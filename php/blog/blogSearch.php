...
<body>
    ...
    $sql = "SELECT b.blogID, b.blogCategory, b.blogTitle, b.blogContents, m.youName, b.blogRegTime, b.blogImgFile, b.blogView FROM myBlog b JOIN myMember m ON(b.memberID = m.memberID) WHERE b.blogTitle LIKE '%{$searchKeyword}%' ORDER BY blogID DESC";
...
<?php
    ...
    $sql = "SELECT b.blogID, b.blogCategory, b.blogTitle, b.blogContents, m.youName, b.blogRegTime, b.blogImgFile, b.blogView FROM myBlog b JOIN myMember m ON(b.memberID = m.memberID) WHERE b.blogTitle LIKE '%{$searchKeyword}%' ORDER BY blogID DESC LIMIT {$PageLimit},{$PageView}";
    $result = $connect -> query($sql);
?>
